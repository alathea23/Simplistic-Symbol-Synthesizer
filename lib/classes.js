...
class Triangle extends Shape {
  ...
  render() {
    ...
    fill="${this.color}" stroke="${this.borderColor}" stroke-width="5"/>`;
  }
}
...
class Rectangle extends Shape {
  ...
  render() {
    return `<rect x="10" y="10" width="90%" height="90%" fill="${this.color}" stroke="${this.borderColor}" stroke-width="5"/>`;
  }
}
...
class Circle extends Shape {
  ...
  render() {
    return `<circle cx="150" cy="100" r="100" fill="${this.color}" stroke="${this.borderColor}" stroke-width="5"/>`;
  }
}
